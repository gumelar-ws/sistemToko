  ...
  return (
    <div>
      <div className="container">
        <HederPathProductList content1="HOME" content2="T-SHIRT COLLECTION" content3="T-SHIRT" content4="DETAIL" content4Style="fw-bold" content5Style="d-none" display="d-none" />
      </div>
      <DetailComponent />
    </div>
  );
