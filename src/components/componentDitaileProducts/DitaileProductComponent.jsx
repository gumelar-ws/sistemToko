...
import RelateProducts from './childDitailComponent/RelateProducts';
import LineText from '../lineText/LineText';
import ProductCarouselImage from './childDitailComponent/ProductCarouselImage';
        ...
        <div className="container-fluid">
          <div className="container">
            <div className="row">
              <div className="col-md-6">
                <ProductCarouselImage detailProduct={detailProduct} detailProductChilds={detailProductChilds} />
              </div>
          ...
          <div className="container">
            <div className="related-products">
              ...
              <div className="row ">
                <RelateProducts relatedProducts={relatedProducts} scrollTop={scrollTop} />
              </div>
            </div>
          </div>
        </div>
